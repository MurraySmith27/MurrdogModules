...
namespace SharpVoronoiLib
{
    ...
    internal class BeachLine
    {
        ...
        internal void AddBeachSection(FortuneSiteEvent siteEvent, MinHeap<FortuneEvent> eventQueue,
            List<VoronoiEdge> edges)
        {
            ...
            FindSectionsForInsertion(x, directrix, out RBTreeNode<BeachSection> leftSection,
                out RBTreeNode<BeachSection> rightSection);
        ...
        /// </summary>
        internal void RemoveBeachSection(FortuneCircleEvent circle, MinHeap<FortuneEvent> eventQueue,
            List<VoronoiEdge> edges)
        {
            ...
            List<RBTreeNode<BeachSection>> toBeRemoved = new();
        ...
        /// </summary>
        private void FindSectionsForInsertion(double x, double directrix, out RBTreeNode<BeachSection> leftSection,
            out RBTreeNode<BeachSection> rightSection)
        {
            leftSection = null;
            rightSection = null;
