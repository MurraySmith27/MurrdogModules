...
namespace SharpVoronoiLib.Exceptions
{
    ...
    public class VoronoiSiteSkippedAsDuplicateException : Exception
    {
        public VoronoiSiteSkippedAsDuplicateException() : base(
            "This site was skipped during tessellation because it duplicates another site. " +
