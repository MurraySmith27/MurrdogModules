...
namespace ChocDino.UIFX.Editor
{
	...
	internal class OutlineFilterEditor : FilterBaseEditor
	{
		...
		private SerializedProperty _useGradient;
		...
		void OnEnable()
		{
			...
			_propColor1 = VerifyFindProperty("_color1");
			_propColor2 = VerifyFindProperty("_color2");
			_gradientType = VerifyFindProperty("_gradientType");
			_useGradient = VerifyFindProperty("_useGradient");
			_offset = VerifyFindProperty("_offset");
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(_useGradient);
