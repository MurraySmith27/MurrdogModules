...
public partial class SROptions : INotifyPropertyChanged
{
    ...
    // zw: make the event queue static to let other module able to handler dev menu events
    // currently for triggering refreshing daily deals
    public static event SROptionsPropertyChanged PropertyChanged;
