...
public class BlitMaterialFeature : ScriptableRendererFeature {
    class RenderPass : ScriptableRenderPass {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            RenderingUtils.ReAllocateIfNeeded(ref tempTextureHandle, desc, FilterMode.Point, TextureWrapMode.Clamp, name: "_TempHandle");
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
            ...
            Blit(cmd, sourceID, tempTextureHandle, material, materialPassIndex);
            Blit(cmd, tempTextureHandle, sourceID);
